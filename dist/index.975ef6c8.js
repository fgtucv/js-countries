...
},{"@pnotify/core":"9RSjy","@pnotify/core/dist/BrightTheme.css":"grIyt","./js/fetchCountries.js":"dKuy9"}],"9RSjy":[function(require,module,exports,__globalThis) {
var global = arguments[3];
!function(t, e) {
    e(exports);
}(this, function(t) {
...
},{}],"grIyt":[function() {},{}],"dKuy9":[function(require,module,exports,__globalThis) {
var _core = require("@pnotify/core");
var _brightThemeCss = require("@pnotify/core/dist/BrightTheme.css");
...
const createMarkup = (arr)=>{
    ...
    html = "";
    if (arr.length > 10) (0, _core.notice)({
        text: "\u0414\u0430\u0439\u0442\u0435 \u0431\u0456\u043B\u044C\u0448 \u0434\u0435\u0442\u0430\u043B\u044C\u043D\u0438\u0439 \u0437\u0430\u043F\u0438\u0442",
        type: 'info',
        delay: 3000
    });
    else if (arr.length >= 2 && arr.length <= 10) html = arr.map((obj)=>{
        return `<li>
                <h1>${obj.name.official}</h1>
            </li>`;
    }).join("");
    else if (arr.length === 1) html = arr.map((obj)=>{
        return `<li>
...
},{"@pnotify/core":"9RSjy","@pnotify/core/dist/BrightTheme.css":"grIyt","@pnotify/core/dist/PNotify.css":"c4y47"}],"grIyt":[function() {},{}],"c4y47":[function() {},{}]},["9mu7C","8lqZg"], "8lqZg", "parcelRequire94c2")
